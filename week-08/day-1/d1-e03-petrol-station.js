...
let car = {
  ...
  petrolSpace: 0,
  refill: function() {
    this.petrolSpace = this.petrolCapacity - this.petrolLevel;
    if (this.petrolSpace >= 0 && this.petrolSpace <= 50) {
      this.petrolLevel += this.petrolSpace;
    }
    return this.petrolSpace;
  }
};
